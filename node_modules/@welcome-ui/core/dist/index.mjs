...
var getButtons = (theme) => {
  ...
  return {
    ...
    hover: {
      ...
      tertiary: {
        backgroundColor: hexToRGBA(colors2["neutral-90"], 0.1)
      },
      ghost: {
        backgroundColor: hexToRGBA(colors2["neutral-90"], 0.1)
      },
    ...
    active: {
      ...
      tertiary: {
        backgroundColor: hexToRGBA(colors2["neutral-90"], 0.4)
      },
      ghost: {
        backgroundColor: hexToRGBA(colors2["neutral-90"], 0.4)
      },
...
// src/utils/base.ts
import { createGlobalStyle, css as css4, th } from "@xstyled/styled-components";
...
// src/utils/reset.ts
import { css as css3 } from "@xstyled/styled-components";
var resetStyles = css3`
  html,
  body,
  div,
  span,
...
var WuiProvider = ({
  ...
  return /* @__PURE__ */ React.createElement(ThemeProvider, { theme }, /* @__PURE__ */ React.createElement(React.Fragment, null, hasGlobalStyle && /* @__PURE__ */ React.createElement(GlobalStyle, { useReset }), shouldHideFocusRingOnClick ? /* @__PURE__ */ React.createElement(HideFocusRingsRoot, { reactRootId }, children) : children));
};
