...
type CSSScalar = undefined | string | number;
interface CSSObject extends CSSProperties, CSSPseudos {
    [key: string]: CSSObject | CSSScalar;
}
type CSSFromProps<TProps = {}> = (props: TProps) => CSSObject | null | undefined;
type Mixin = (value: any) => CSSFromProps | CSSObject | null | undefined;
type ThemeAlias = (props: Props<Theme>) => ThemeValue;
type ThemeValue = undefined | null | string | string[] | number | number[] | ThemeAlias | ThemeNamespace;
interface States {
...
type NamespaceType<T> = T extends ReadonlyArray<unknown> ? number : T extends Array<unknown> ? number : T extends {
    default: ThemeValue;
} ? keyof T | true : T extends ThemeNamespace ? keyof T : {};
type ThemeScreens<T extends ITheme> = T extends {
    screens: Screens;
} ? T['screens'] : unknown;
type ThemeStates<T extends ITheme> = T extends {
    states: States;
} ? T['states'] : unknown;
type ThemeVariants<T extends ITheme> = ThemeScreens<T> & Omit<ThemeStates<T>, '_'>;
type ThemeProp<TType, TTheme extends ITheme> = {
    [P in keyof ThemeVariants<TTheme>]?: TType | ThemeProp<TType, TTheme>;
};
type SystemProp<TType, TTheme extends ITheme> = TType | ThemeProp<TType, TTheme>;
type CSSOption = string | string[] | Mixin;
 ...
 */
type SynthesizedPath<T extends Record<string, unknown>> = {
    [P in keyof T]: P extends string ? T[P] extends Record<string, unknown> ? `${P}.${SynthesizedPath<T[P]>}` : P : never;
}[keyof T];
type ThemeNamespaceValue<K extends string, T extends ITheme> = NamespaceType<T[K]> | {};
...
type ThemeGetterType<T extends ThemeGetter> = T extends ThemeGetter<infer T> ? T : never;
type StyleGeneratorProps<T> = T extends StyleGenerator<infer Props> ? Props : never;
type StyleGeneratorPropsConcat<T> = T extends [infer Head, ...infer Tail] ? StyleGeneratorProps<Head> & StyleGeneratorPropsConcat<Tail> : unknown;
...
type ThemeDuration<T extends ITheme = Theme> = ThemeNamespaceValue<'durations', T>;
type Duration<T extends ITheme = Theme> = ThemeDuration<T> | number | string;
...
type ThemeTransition<T extends ITheme = Theme> = ThemeNamespaceValue<'transitions', T>;
declare const getTransition: ThemeGetter<ThemeTransition<Theme>>;
type ThemeTransitionProperty<T extends ITheme = Theme> = ThemeNamespaceValue<'transitionProperties', T>;
declare const getTransitionProperty: ThemeGetter<ThemeTransitionProperty<Theme>>;
type ThemeTimingFunction<T extends ITheme = Theme> = ThemeNamespaceValue<'timingFunctions', T>;
...
type ThemeAnimation<T extends ITheme = Theme> = ThemeNamespaceValue<'animations', T>;
...
type HslColor = `hsl(${number}, ${number}%, ${number}%)` | `hsla(${number}, ${number}%, ${number}%, ${number})`;
type LabColor = `lab(${number}% ${number} ${number})` | `lab(${number}% ${number} ${number} / ${number})`;
type HwbColor = `hwb(${number} ${number}% ${number}%)` | `hwb(${number} ${number}% ${number}% / ${number})`;
type FnColor = `${string}(${string})`;
type ThemeColor<T extends ITheme = Theme> = SynthesizedPath<T['colors']>;
/**
 ...
 * for typos and such.
 */
type Color<T extends ITheme = Theme> = ThemeColor<T> | CSS.DataType.NamedColor | CSS.DataType.DeprecatedSystemColor | CSS.Globals | HexColor | RgbColor | HslColor | LabColor | HwbColor | FnColor | 'currentcolor';
...
type BackgroundColorProp<T extends ITheme> = SystemProp<ThemeColor<T> | CSS.Property.BackgroundColor, T>;
...
type ThemeBorder<T extends ITheme = Theme> = ThemeNamespaceValue<'borders', T>;
type BorderValue = number | string;
type Border<T extends ITheme = Theme> = BorderValue | ThemeBorder<T>;
declare const getBorder: ThemeGetter<ThemeBorder<Theme>>;
type ThemeBorderWidth<T extends ITheme = Theme> = ThemeNamespaceValue<'borderWidths', T>;
type BorderWidth<T extends ITheme = Theme> = Pixel | ThemeBorderWidth<T>;
declare const getBorderWidth: ThemeGetter<ThemeBorderWidth<Theme>>;
type ThemeBorderColor<T extends ITheme = Theme> = ThemeColor<T>;
declare const getBorderColor: ThemeGetter<string>;
type ThemeBorderStyle<T extends ITheme = Theme> = ThemeNamespaceValue<'borderStyles', T>;
...
type ThemeRadius<T extends ITheme = Theme> = ThemeNamespaceValue<'radii', T>;
type Radius<T extends ITheme = Theme> = Pixel | ThemeRadius<T>;
...
type ThemeRingWidth<T extends ITheme = Theme> = ThemeNamespaceValue<'ringWidths', T>;
type RingWidth<T extends ITheme = Theme> = Pixel | ThemeRingWidth<T>;
...
type ThemeShadow<T extends ITheme = Theme> = ThemeNamespaceValue<'shadows', T>;
...
type ThemeZIndex<T extends ITheme = Theme> = ThemeNamespaceValue<'zIndices', T>;
...
type ThemeInset<T extends ITheme = Theme> = ThemeNamespaceValue<'inset', T>;
type Inset<T extends ITheme = Theme> = Pixel | ThemeInset<T>;
...
type ThemeSpace<T extends ITheme = Theme> = ThemeNamespaceValue<'space', T>;
type Space<T extends ITheme = Theme> = Pixel | ThemeSpace<T>;
declare const getSpace: ThemeGetter<ThemeSpace<Theme>>;
type MarginProp<T extends ITheme> = SystemProp<Space<T> | CSS.Property.Margin, T>;
interface MarginProps<T extends ITheme = Theme> {
    margin?: MarginProp<T>;
    m?: MarginProp<T>;
}
declare const margin: StyleGenerator<{}>;
type MarginTopProp<T extends ITheme> = SystemProp<Space<T> | CSS.Property.MarginTop, T>;
...
type MarginRightProp<T extends ITheme> = SystemProp<Space<T> | CSS.Property.MarginRight, T>;
...
type MarginBottomProp<T extends ITheme> = SystemProp<Space<T> | CSS.Property.MarginBottom, T>;
...
type MarginLeftProp<T extends ITheme> = SystemProp<Space<T> | CSS.Property.MarginLeft, T>;
...
type PaddingProp<T extends ITheme> = SystemProp<Space<T> | CSS.Property.Padding, T>;
...
type PaddingTopProp<T extends ITheme> = SystemProp<Space<T> | CSS.Property.PaddingTop, T>;
...
type PaddingRightProp<T extends ITheme> = SystemProp<Space<T> | CSS.Property.PaddingRight, T>;
...
type PaddingBottomProp<T extends ITheme> = SystemProp<Space<T> | CSS.Property.PaddingBottom, T>;
...
type PaddingLeftProp<T extends ITheme> = SystemProp<Space<T> | CSS.Property.PaddingLeft, T>;
...
type ThemeSize<T extends ITheme = Theme> = ThemeNamespaceValue<'sizes', T>;
type Size<T extends ITheme = Theme> = Percent | ThemeSize<T>;
...
type MaxWidthProp<T extends ITheme> = SystemProp<Size<T> | CSS.Property.MaxWidth, T>;
...
type MaxHeightProp<T extends ITheme> = SystemProp<Size<T> | CSS.Property.MaxHeight, T>;
...
type MinHeightProp<T extends ITheme> = SystemProp<Size<T> | CSS.Property.MinHeight, T>;
...
type ThemeTransform<T extends ITheme = Theme> = ThemeNamespaceValue<'transforms', T>;
...
type ThemeFont<T extends ITheme = Theme> = ThemeNamespaceValue<'fonts', T>;
declare const getFont: ThemeGetter<ThemeFont<Theme>>;
type ThemeLineHeight<T extends ITheme = Theme> = ThemeNamespaceValue<'lineHeights', T>;
type LineHeightValue = number | string;
type LineHeight<T extends ITheme = Theme> = LineHeightValue | ThemeLineHeight<T>;
declare const getLineHeight: ThemeGetter<ThemeLineHeight<Theme>>;
type ThemeFontWeight<T extends ITheme = Theme> = ThemeNamespaceValue<'fontWeights', T>;
declare const getFontWeight: ThemeGetter<ThemeFontWeight<Theme>>;
type ThemeLetterSpacing<T extends ITheme = Theme> = ThemeNamespaceValue<'letterSpacings', T>;
type LetterSpacing<T extends ITheme = Theme> = Pixel | ThemeLetterSpacing<T>;
declare const getLetterSpacing: ThemeGetter<ThemeLetterSpacing<Theme>>;
type ThemeFontSize<T extends ITheme = Theme> = ThemeNamespaceValue<'fontSizes', T>;
type FontSize<T extends ITheme = Theme> = Pixel | ThemeFontSize<T>;
...
type ThemeText<T extends ITheme = Theme> = ThemeNamespaceValue<'texts', T>;
...
type ColorVariants = number[] | readonly number[];
type ColorTones = number[];
...
type PropsVariants<T extends Props> = PropsScreensVariants<T> & PropsStates<T>;
