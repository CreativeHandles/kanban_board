import styled$1, { createGlobalStyle as createGlobalStyle$1, ThemeContext, ThemeProvider, useTheme, css as css$1 } from 'styled-components';
...
const createCreateGlobalStyle = (generator) => {
  ...
  return (...args) => createGlobalStyle$1([css(...args)]);
};
...
const createShouldForwardProp = (generator) => {
  ...
  return (prop, elementToBeCreated) => {
...
const createX = (generator) => {
  const xstyled = createBaseStyled(
    createCssFunction(generator),
    generator
  );
  const x = {};
